package com.emedicare.productService.service;

import com.emedicare.productService.dto.ProductDTO;
import com.emedicare.productService.entity.ProductEntity;
import com.emedicare.productService.repository.ProductRepository;
...
public class ProductService {
  ...
  public List<ProductDTO> readManyByType(
    String productType,
    Integer pageNumber,
    Integer itemCount
  ) {
    Page<ProductEntity> productEntitiesPage =
      this.productRepository.findAllByType(
          productType,
          PageRequest.of(pageNumber, itemCount)
        );
    List<ProductDTO> productDTOs = new LinkedList<ProductDTO>();
